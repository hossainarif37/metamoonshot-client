    ...
    return (
        <div className='pb-20'>
            <div className='bg-[#292337] w-10/12 lg:w-9/12 mx-auto rounded-2xl py-14 relative'>
                <img className='w-20 lg:w-28  rotate-[18deg] absolute left-[-28px] top-[-42px]' src={cheese1} alt="" />
                ...
                <img className='w-20 lg:w-28 absolute bottom-[-24px] lg:bottom-[-30px] right-[-30px] lg:right-[-43px]' src={cheese2} alt="" />
            </div>
